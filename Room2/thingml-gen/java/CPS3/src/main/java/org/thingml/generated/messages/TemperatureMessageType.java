...
public Event instantiate(final short id, final String txt, final float t) { return new TemperatureMessage(this, id, txt, t); }
@Override
...
protected TemperatureMessage(EventType type, final short id, final String txt, final float t) {
super(type);
this.id = id;
this.txt = txt;
this.t = t;
